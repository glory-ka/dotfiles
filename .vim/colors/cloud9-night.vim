...
" call <SID>X("rubyBlock", s:aqua, "", "")
  ...
  call <SID>X("cssMediaProp", s:yellow, "", "")
  call <SID>X("cssFlexibleBoxProp", s:yellow, "", "")
  call <SID>X("cssInteractProp", s:yellow, "", "")
  call <SID>X("cssAnimationProp", s:yellow, "", "")
  ...
  call <SID>X("jsAsyncKeyword", s:purple, "", "")
  ...
  call <SID>X("jsForAwait", s:purple, "", "")
